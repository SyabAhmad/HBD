...
export default function CandleBlowScreen({ isVisible, onNext }) {
    ...
    <ScreenContainer isVisible={isVisible}>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-8 py-16">
        <div className="text-center space-y-12 max-w-4xl w-full">
          {/* Cake with candles - More Realistic */}
          <div
            className={
              candlesLit ? "" : "transition-opacity duration-1000 opacity-50"
            }
          >
            <svg
              width="320"
            ...
            >
              ...
              {candlesLit && (
                <>
                  <ellipse cx="116" cy="67" rx="8" ry="14" fill="#FFD700" className="flame-flicker" opacity="0.9" />
                  <ellipse cx="116" cy="62" rx="6" ry="10" fill="#FFA500" className="flame-flicker" />

                  <ellipse cx="141" cy="67" rx="8" ry="14" fill="#FFD700" className="flame-flicker" style={{ animationDelay: "0.1s" }} opacity="0.9" />
                  <ellipse cx="141" cy="62" rx="6" ry="10" fill="#FFA500" className="flame-flicker" style={{ animationDelay: "0.1s" }} />

                  <ellipse cx="166" cy="62" rx="8" ry="14" fill="#FFD700" className="flame-flicker" style={{ animationDelay: "0.2s" }} opacity="0.9" />
                  <ellipse cx="166" cy="57" rx="6" ry="10" fill="#FFA500" className="flame-flicker" style={{ animationDelay: "0.2s" }} />

                  <ellipse cx="191" cy="67" rx="8" ry="14" fill="#FFD700" className="flame-flicker" style={{ animationDelay: "0.15s" }} opacity="0.9" />
                  <ellipse cx="191" cy="62" rx="6" ry="10" fill="#FFA500" className="flame-flicker" style={{ animationDelay: "0.15s" }} />

                  <ellipse cx="216" cy="67" rx="8" ry="14" fill="#FFD700" className="flame-flicker" style={{ animationDelay: "0.25s" }} opacity="0.9" />
                  <ellipse cx="216" cy="62" rx="6" ry="10" fill="#FFA500" className="flame-flicker" style={{ animationDelay: "0.25s" }} />
                </>
              )}
          ...
          {candlesLit ? (
            <div className="space-y-8">
              ...
              <Button onClick={handleBlow} variant="primary">
                Blow the Candles 🎂
              </Button>
            </div>
          ) : (
            <div className="space-y-6">
              <p className="text-3xl md:text-4xl font-semibold text-(--charcoal)">
                ✨ Wish made!
              </p>
